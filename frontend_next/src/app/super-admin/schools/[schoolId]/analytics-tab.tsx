...
import { Activity, Cpu, FileText, RefreshCw, Users } from "lucide-react";
...
export function SuperAdminSchoolAnalyticsTab({
  schoolId,
}: {
  schoolId: number;
}) {
  ...
  const { data, isLoading, isFetching, refetch } = useQuery({
    queryKey: ["super-admin-school-analytics", schoolId, period],
    queryFn: () => api.superAdminSchoolAnalytics(schoolId, period),
  });
        ...
        <CardContent className="p-5">
          <div className="mb-1">
            ...
            <p className="text-xs text-muted-foreground">
              Total actions per day in this school.
            </p>
          </div>
          {isLoading ? (
        ...
        <CardContent className="p-5">
          <div className="mb-3 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                All-time count of each AI feature in this school.
              </p>
            </div>
            {!isLoading && (
